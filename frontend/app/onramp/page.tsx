...
export const metadata = {
  ...
  description: "Get the best real-time quotes to instantly buy sBTC with no mandatory KYC.",
};
        ...
        <div className="container mx-auto px-4 relative z-10 block">
          <div className="text-center mb-12 animate-fade-in">
            ...
            <p className="text-zinc-400 max-w-lg mx-auto text-lg leading-relaxed">
              We aggregate the market to find you the lowest fees and fastest routes without mandatory KYC checks. 
            </p>
          </div>
          ...
          <div className="mt-16 max-w-2xl mx-auto text-center border-t border-white/5 pt-12 animate-fade-in">
            ...
            <p className="text-zinc-400 text-sm leading-relaxed mb-6">
              When converting natively through MVP providers, most deliver Bitcoin (<span className="text-white">BTC</span>). To ensure you get <span className="text-primary font-medium">sBTC</span> instantly and trustlessly into your Stacks wallet, we automatically prepare the routing through the official Stacks sBTC peg process as soon as your quote gets filled. Ensure you have your Leather or Xverse wallet connected.
            </p>
            <div className="inline-flex items-center justify-center p-1 rounded-full bg-white/5 border border-white/10">
              ...
              <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-primary/10 border border-primary/20 text-primary font-medium text-xs whitespace-nowrap">
                <div className="w-3.5 h-3.5 bg-primary text-black rounded-full flex items-center justify-center text-[8px] font-bold">₿</div>
                Stacks sBTC
              </div>
            </div>
          </div>
